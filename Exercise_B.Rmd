...
#Changing Data Types
ena$measurement_date<-as.Date(ena$measurement_date)
...
cat_num_07<-a_07_18 %>% group_by(z_cat_WHO) %>% summarise(count=n())
cat_num_07$prop <- round(cat_num_07$count*100/sum(cat_num_07$count))
